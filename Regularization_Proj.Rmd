...
- <span style="color:black; font-weight:bold"> Adjusted $\boldsymbol{R^2}$ Value:</span> The Adjusted $R^2$ Value is a modified version of the $R^2$ that better accounts for model complexity and number of predictors. Let $n$ be sample size, $k$ be number of parameters, $\bar{y}$ be the average of the response variable, then the adjusted $R^2$ Value is denoted as follows (CITE: primer paper). 
